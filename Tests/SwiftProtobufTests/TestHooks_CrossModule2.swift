...
extension CrossModule2_Msg {
  var hashValue: Int {
    print("CrossModule2_Msg.hashValue called!")
    return field1.hashValue
  }

  static func ==(lhs: CrossModule2_Msg, rhs: CrossModule2_Msg) -> Bool {
...
class TestHooks_CrossModule2: XCTestCase {
  // Type aliases so diffing test files is easier.
  typealias MESSAGE = CrossModule2_Msg
  typealias MESSAGEAsField = CrossModule2_MsgAsField
  typealias MESSAGEInArray = CrossModule2_MsgInArray
  typealias MESSAGEInArrayInHeapStorage = CrossModule2_MsgInArrayInHeapStorage
  typealias MESSAGEInMap = CrossModule2_MsgInMap
  typealias MESSAGEInMapInHeapStorage = CrossModule2_MsgInMapInHeapStorage
  ...
  func testMsgInLocalArray() {
    ...
    XCTAssertTrue(localArrayA == localArrayB)
