...
extension SameModule3_HeapStorage_Msg {
  var hashValue: Int {
    print("SameModule3_HeapStorage_Msg.hashValue called!")
...
class TestHooks_SameModule3_HeapStorage: XCTestCase {
  // Type aliases so diffing test files is easier.
  typealias MESSAGE = SameModule3_HeapStorage_Msg
  typealias MESSAGEAsField = SameModule3_HeapStorage_MsgAsField
  typealias MESSAGEInArray = SameModule3_HeapStorage_MsgInArray
  typealias MESSAGEInArrayInHeapStorage = SameModule3_HeapStorage_MsgInArrayInHeapStorage
  typealias MESSAGEInMap = SameModule3_HeapStorage_MsgInMap
  typealias MESSAGEInMapInHeapStorage = SameModule3_HeapStorage_MsgInMapInHeapStorage
