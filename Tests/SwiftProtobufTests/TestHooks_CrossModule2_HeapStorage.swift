...
extension CrossModule2_HeapStorage_Msg {
  var hashValue: Int {
    print("CrossModule2_HeapStorage_Msg.hashValue called!")
    return field1.hashValue
  }

  static func ==(lhs: CrossModule2_HeapStorage_Msg, rhs: CrossModule2_HeapStorage_Msg) -> Bool {
    return lhs.hasField1 == rhs.hasField1 && lhs.field1 == rhs.field1
  }
}


class TestHooks_CrossModule2_HeapStorage: XCTestCase {
  // Type aliases so diffing test files is easier.
  typealias MESSAGE = CrossModule2_HeapStorage_Msg
  typealias MESSAGEAsField = CrossModule2_HeapStorage_MsgAsField
  typealias MESSAGEInArray = CrossModule2_HeapStorage_MsgInArray
  typealias MESSAGEInArrayInHeapStorage = CrossModule2_HeapStorage_MsgInArrayInHeapStorage
  typealias MESSAGEInMap = CrossModule2_HeapStorage_MsgInMap
  typealias MESSAGEInMapInHeapStorage = CrossModule2_HeapStorage_MsgInMapInHeapStorage
